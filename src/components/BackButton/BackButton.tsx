...
export const BackButton: React.FC = () => {
    return (
        <Link to="/" className={styles['back-button']} aria-label="Вернуться назад">
            ...
            <svg className={`${styles['back-button__icon']} ${styles['back-button__icon--large']}`} width="12"
                 height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11.25 6H0.75" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M6 11.25L0.75 6L6 0.75" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>

            <svg className={`${styles['back-button__icon']} ${styles['back-button__icon--small']}`} width="6"
