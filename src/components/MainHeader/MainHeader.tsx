        ...
        <nav className={styles.header__nav}>
          <ul className={styles['header__nav-list']}>
            <li className={styles['header__nav-item']}>
              <svg
                className={`${styles['header__nav-icon']} ${styles['header__nav-icon--favorite']}`}
                width='13'
                height='12'
                viewBox='0 0 13 12'
                fill='none'
            ...
            <li className={styles['header__nav-item']}>
              <svg
                className={`${styles['header__nav-icon']} ${styles['header__nav-icon--notification']}`}
                width='13'
                height='14'
                viewBox='0 0 13 14'
                fill='none'
