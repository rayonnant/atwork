...
export const DropdownButton: React.FC<DropdownButtonProps> = ({
  ...
  return (
    <button
      className={`${styles['dropdown-button']} ${isOpen ? styles['dropdown-button--active'] : ''}`}
    ...
    >
      <svg
        className={`${styles['dropdown-button__icon']} ${styles['dropdown-button__icon--small']}`}
        width='3'
        height='10'
        viewBox='0 0 3 10'
        fill='none'
      ...
      <svg
        className={`${styles['dropdown-button__icon']} ${styles['dropdown-button__icon--large']}`}
        width='4'
        height='16'
        viewBox='0 0 4 16'
        fill='none'
